...
|JENKINSGRADLEPLUGIN_GRADLE_PLUGIN_REPOSITORY_URL|Gradle|The URL of the repository to use when resolving the GE and CCUD plugins. Required if Jenkins agents are not able to access the Gradle Plugin Portal.
