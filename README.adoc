...
|JENKINSGRADLEPLUGIN_GRADLE_INJECTION_ENABLED_NODES|Gradle|Comma separated list. Labels of nodes where Gradle injection should be enabled.
|JENKINSGRADLEPLUGIN_GRADLE_INJECTION_DISABLED_NODES|Gradle|Comma separated list. Labels of nodes where Gradle injection should be disabled.
...
|JENKINSGRADLEPLUGIN_MAVEN_INJECTION_ENABLED_NODES|Maven|Comma separated list. Labels of nodes where Maven injection should be enabled.
|JENKINSGRADLEPLUGIN_MAVEN_INJECTION_DISABLED_NODES|Maven|Comma separated list. Labels of nodes where Maven injection should be disabled.
|===
